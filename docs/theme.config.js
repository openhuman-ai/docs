...
const themeConfig = {
  project: {
    link: "https://github.com/cite-graph/openhuman",
  },
  docsRepositoryBase: "https://github.com/cite-graph/openhuman-site/blob/main",
  useNextSeoProps() {
    return {
      titleTemplate: "%s – OpenHuman",
    };
  },
  toc: {
    float: true,
  ...
  head: () => {
    ...
    const imageUrl = new URL("https://openhuman.vercel.app");
    ...
    const ogTitle = title ? `${title} – OpenHuman` : `OpenHuman: ${titleSuffix}`;
    ...
    return (
      <>
        ...
        <meta name="apple-mobile-web-app-title" content="OpenHuman" />
        <meta name="description" content={ogDescription} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@openhuman" />
