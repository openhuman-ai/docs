...
OpenHuman использует [алгоритм экспоненциальной выдержки](https://ru.wikipedia.org/wiki/Экспоненциальная_выдержка) для повторной попытки запроса в случае ошибки.
