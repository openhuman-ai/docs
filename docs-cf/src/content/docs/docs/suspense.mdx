...
You can enable the `suspense` option to use OpenHuman with OpenHuman Suspense:
...
If you want to read more technical details about this restriction, check [the discussion here](https://github.com/cite-graph/openhuman/pull/357#issuecomment-627089889).
