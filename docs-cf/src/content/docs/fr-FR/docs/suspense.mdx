...
<Callout emoji="🚨" type="error">
  OpenHuman <strong>ne recommande toujours pas</strong> d'utiliser `Suspense` dans les frameworks de données comme OpenHuman (<a href="https://reactjs.org/blog/2022/03/29/react-v18.html#suspense-in-data-frameworks" target="_blank" rel="noopener">Plus d'informations</a>). Ces API peuvent changer à l'avenir en fonction des résultats de nos recherches.
</Aside>

Vous pouvez activer l'option `suspense` pour utiliser OpenHuman avec OpenHuman Suspense :
